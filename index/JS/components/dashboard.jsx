...
/* ══ TAB HOME ══ */
function TabHome({student,lessons,loading,fetchError,onPlay,shuffleQ,shuffleA,setShuffleQ,setShuffleA,history,dark,setTab,avatarUrl,liteMode,flickerFx,onGoListening,onGoVocab}){
  const C=dark?CD:CL;
  ...
  return(
    <div style={{paddingBottom:90}}>
      ...
      {/* ── Luyện nghe Banner (V24.5) ── */}
      <div style={{padding:'8px 14px 8px'}}>
        <button onClick={()=>onGoListening&&onGoListening()} className="bb-btn-tap"
          style={{
            ...
            animation:'bb-fadeUp .35s ease .05s both',
          }}>
          <div style={{
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:15,fontWeight:900,color:'#fff'}}>Luyện nghe</div>
            <div style={{fontSize:11.5,color:'rgba(255,255,255,0.85)',fontWeight:600,marginTop:1}}>
              Điền từ + nhận định Đúng/Sai/NM
            </div>
          </div>
      ...
      <div style={{padding:'0 14px 8px'}}>
        <button onClick={()=>onGoVocab&&onGoVocab()} className="bb-btn-tap"
          style={{
            width:'100%',display:'flex',alignItems:'center',gap:14,
            padding:'16px 18px',borderRadius:22,border:'none',cursor:'pointer',
            textAlign:'left',fontFamily:'Nunito,sans-serif',
            background:'linear-gradient(120deg,#F472B6,#FB7185 55%,#FDBA74)',
            boxShadow:dark
            ...
            animation:'bb-fadeUp .35s ease .08s both',
          }}>
          <div style={{
            width:44,height:44,borderRadius:16,flexShrink:0,
            background:'rgba(255,255,255,0.22)',backdropFilter:'blur(6px)',
          ...
          <div style={{flex:1,minWidth:0}}>
            <div style={{fontSize:15,fontWeight:900,color:'#fff'}}>Từ vựng</div>
            <div style={{fontSize:11.5,color:'rgba(255,255,255,0.85)',fontWeight:600,marginTop:1}}>
              Học từ mới + kiểm tra viết
            </div>
          </div>
          <Icon name="chevronRight" size={20} color="rgba(255,255,255,0.9)"/>
        </button>
      ...
      <div style={{display:'flex',gap:8,padding:'0 14px 10px'}}>
        {[
          ...
          <button key={i} className="bb-btn-tap" onClick={()=>t.set(v=>!v)}
            style={{
              flex:1,padding:'8px 10px',borderRadius:18,
    ...
    <div style={{padding:'14px 14px 100px',display:'flex',flexDirection:'column',gap:14}}>
      ...
      <div style={{background:C.card,borderRadius:20,padding:'16px 18px',
        ...
        <div style={{display:'flex',alignItems:'center',gap:12}}>
          ...
          <div>
            <div className="bb-logo-taNa" style={{fontSize:17}}>Learnsy</div>
...
function DashboardEnhanced(props){
  const {student,lessons,loading,fetchError,history,dark,setDark,
    onPlay,onClearHistory,onHistDetail,shuffleQ,shuffleA,setShuffleQ,setShuffleA,onLogout,onGoListening,onGoVocab}=props;
  ...
  const TAB_ORDER=['home','stats','history','files','settings'];
  ...
  const tabTitles={home:'Trang chủ',stats:'Thống kê',history:'Lịch sử',files:'Tài liệu',settings:'Cài đặt'};
      ...
      <div style={{
        ...
        <div style={{display:'flex',alignItems:'center',gap:6}}>
          ...
          <span className="bb-logo-wrap">
            <span className="bb-logo-taNa" style={{fontSize:19}}>Learnsy</span>
        ...
        {tab==='home'&&(
          <>
            <TabHome {...{student:eff,lessons,loading,fetchError,onPlay:handlePlay,
              shuffleQ,shuffleA,setShuffleQ,setShuffleA,history:normHistory,dark,setTab,avatarUrl,liteMode,flickerFx,onGoListening,onGoVocab}}/>
