      ...
      >
        ...
        <div style={{marginBottom:14}}>
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:8}}>
            ...
            <button
              onClick={toggleAll}
              style={{fontSize:11,fontWeight:800,color:allChecked?'#FCA5A5':'#C084FC',background:'transparent',border:'none',cursor:'pointer',padding:'2px 4px',fontFamily:'inherit'}}
            >
                  ...
                  {searchQuery&&(
                    <button
                      ...
                      style={{position:'absolute',right:12,top:'50%',transform:'translateY(-50%)',
                        background:'none',border:'none',cursor:'pointer',color:dark?'#8A6080':'#A07090',fontSize:18,lineHeight:1,padding:0}}>
                      ×
                    </button>
                  )}
                </div>
                ...
                {isEmpty&&(
                  <div style={{textAlign:'center',padding:'40px 24px 32px',animation:'fadeUp .22s both'}}>
                    ...
                    {isSearchEmpty&&(
                      <button
                        onClick={handleClearSearch}
                        style={{marginTop:12,padding:'7px 18px',borderRadius:999,border:`1.5px solid ${dark?'#421526':'#F5D5E8'}`,background:dark?'#261018':'#fff',color:dark?'#C898B8':'#A855F7',fontSize:12,fontWeight:800,cursor:'pointer',fontFamily:'inherit'}}>
                        Xóa tìm kiếm
                      </button>
                    )}
                  </div>
              ...
              <>
                <div style={{display:'flex',alignItems:'center',gap:8,marginBottom:12}}>
                  ...
                  <button
                    ...
                    style={{padding:'4px 11px',borderRadius:999,border:`1.5px solid ${dark?'#421526':'#F5D5E8'}`,background:dark?'#2D0A1A':'#FFF0F5',color:'#EF4444',fontSize:11,fontWeight:800,cursor:'pointer'}}>
                    Xóa tất cả
                  </button>
                </div>
