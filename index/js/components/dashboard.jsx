...
function ScoreSVG({pct=0,size=56,dark,showMax=true}){
...
/* ══ TAB HOME ══ */
function TabHome({student,lessons,loading,fetchError,onPlay,shuffleQ,shuffleA,setShuffleQ,setShuffleA,history,dark,setTab,avatarUrl}){
  const C=dark?CD:CL;
        ...
        <div style={{display:'flex',alignItems:'center',gap:14,position:'relative'}}>
          ...
          {history.length>0&&(
            <div style={{flexShrink:0,textAlign:'center',cursor:'pointer'}} onClick={()=>setTab('stats')}>
              <ScoreSVG pct={avgPct} size={58} dark={dark}/>
      ...
      <div style={{padding:'10px 14px 4px'}}>
        <div style={{position:'relative'}}>
          <span style={{position:'absolute',left:13,top:'50%',transform:'translateY(-50%)',pointerEvents:'none',display:'flex',alignItems:'center'}}>
            <Icon name='search' size={15} color={dark?'rgba(244,114,182,0.45)':'rgba(200,100,140,0.45)'}/>
          </span>
          <input value={search} onChange={e=>setSearch(e.target.value)}
            placeholder="Tìm bài học cute..."
            className="bb-input"
            style={{
              ...
              <div key={l.id} onClick={()=>onPlay(l)} className="bb-card-tap"
                ...
                {done?(
                  <div style={{textAlign:'center',flexShrink:0}}>
                    <ScoreSVG pct={done.pct} size={52} dark={dark}/>
  ...
  return(
    <div style={{maxWidth:760,margin:'0 auto',minHeight:'100vh',color:C.fg,position:'relative',fontFamily:'Nunito,sans-serif'}}>
      ...
      <div style={{animation:'bb-fadeUp .22s ease both',position:'relative',zIndex:1}}>
        {tab==='home'    &&<TabHome     {...{student:eff1,lessons,loading,fetchError,onPlay,shuffleQ,shuffleA,setShuffleQ,setShuffleA,history:normHistory,dark,setTab,avatarUrl}}/>}
        ...
        {tab==='home'&&(
          <>
            <TabHome {...{student:eff,lessons,loading,fetchError,onPlay:handlePlay,
              shuffleQ,shuffleA,setShuffleQ,setShuffleA,history:normHistory,dark,setTab,avatarUrl}}/>
