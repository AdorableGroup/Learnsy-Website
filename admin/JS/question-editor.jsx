...
function QEditor({q, qi, onUp, onUpItem, onAddItem, onRemItem, onUpOpt, onAddOpt, onRemOpt, onRemove, canRemove, autoAI, onAIAnswer, dark}){
  ...
  return (
    <div className="fade-up" style={{background: C.surface, ...blurStyle, border:`1.5px solid ${C.border}`, borderRadius: 18, overflow:'hidden', boxShadow:'0 3px 16px rgba(255,100,150,0.06)', borderTop:`3px solid ${accentColor}`, marginBottom:14}}>
      {/* Header row */}
